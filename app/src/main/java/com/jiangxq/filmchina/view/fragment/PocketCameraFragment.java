...
import com.jiangxq.filmchina.model.PortableModel;
...
public class PocketCameraFragment extends BaseFragment implements ArticalListContract.View {
    ...
    protected void initData() {
        mPresenter = new ArticalListPresenter(new PortableModel(getContext()),this);
    }
