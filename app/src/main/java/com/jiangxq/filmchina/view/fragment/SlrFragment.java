...
import com.jiangxq.filmchina.model.SlrModel;
...
public class SlrFragment extends BaseFragment implements ArticalListContract.View {
    ...
    protected void initData() {
        mPresenter = new ArticalListPresenter(new SlrModel(getContext()),this);
    }
