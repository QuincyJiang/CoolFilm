...
public class ExcellentFragment extends BaseFragment implements ArticalListContract.View {
    ...
    protected void initData() {
        mPresenter = new ArticalListPresenter(new ExcellentModel(getContext()),this);
    }
