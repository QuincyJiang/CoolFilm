...
public class RangefinderFragment extends BaseFragment implements ArticalListContract.View {
    ...
    protected void initData() {
        mPresenter = new ArticalListPresenter(new RangeFinderCamModel(getContext()),this);
    }
