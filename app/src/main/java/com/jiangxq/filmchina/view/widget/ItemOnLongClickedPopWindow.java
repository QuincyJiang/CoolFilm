package com.jiangxq.filmchina.view.widget;
...
public class ItemOnLongClickedPopWindow extends PopupWindow {
    /**
     ...
     */
    public ItemOnLongClickedPopWindow(Context context, int type, int width, int height) {
        super(context);
...
//               break;
            case IMAGE_VIEW_POPUPWINDOW: //图片
                this.itemLongClickedPopWindowView = this.itemLongClickedPopWindowInflater.inflate(R.layout.pop_window_layout, null);
                break;
        }
    }
