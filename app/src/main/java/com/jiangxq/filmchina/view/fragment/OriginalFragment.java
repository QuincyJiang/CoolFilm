...
public class OriginalFragment extends BaseFragment implements ArticalListContract.View {
    ...
    protected void initData() {
        mPresenter = new ArticalListPresenter(new OriginalModel(getContext()),this);
    }
