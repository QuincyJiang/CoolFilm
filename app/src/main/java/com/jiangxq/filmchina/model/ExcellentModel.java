...
public class ExcellentModel extends BaseModel {
    ...
    public ExcellentModel(BaseFragment context) {
        super(context);
    }
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getExcellentList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
