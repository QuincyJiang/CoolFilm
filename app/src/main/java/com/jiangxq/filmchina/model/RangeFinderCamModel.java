...
public class RangeFinderCamModel extends BaseModel {
    ...
    public RangeFinderCamModel(BaseFragment context) {
        super(context);
    }
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getRangeFinderList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
