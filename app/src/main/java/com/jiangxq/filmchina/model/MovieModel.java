...
public class MovieModel extends BaseModel {
    ...
    public MovieModel(BaseFragment context) {
        super(context);
    }
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getMovieList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
