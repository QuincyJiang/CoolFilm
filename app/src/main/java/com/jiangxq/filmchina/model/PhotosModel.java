...
public class PhotosModel extends BaseModel {
    ...
    public PhotosModel(BaseFragment context) {
        super(context);
    }
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getPhotosList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
