...
public class ActivitiesModel extends BaseModel {
    ...
    public ActivitiesModel(BaseFragment context) {
        super(context);
    }
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getActivitiesList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
