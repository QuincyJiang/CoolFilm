...
public class OriginalModel extends BaseModel {
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getOriginalList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
