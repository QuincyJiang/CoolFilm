...
public class PortableModel extends BaseModel {
    ...
    public PortableModel(BaseFragment context) {
        super(context);
    }
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getPocketCamList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
