...
public class TalkModel extends BaseModel {
    ...
    public TalkModel(BaseFragment context) {
        super(context);
    }
    ...
    public void getArticalList(int page,Observer<List<ArticaItemBean>> mObservable){
        ...
        Observable<List<ArticaItemBean>> responseBodyObservable = service.getTalkList(page).map(new Func1<ResponseBody, List<ArticaItemBean>>() {
            @Override
